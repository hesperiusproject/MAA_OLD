...
public class RequestHandler {
	...
	public static <T extends JavaPlugin> void start(final T plugin) {
						...
						Bukkit.getServer().getScheduler().runTask(plugin, new Runnable() {
							...
							public void run() {
								...
								for (Object o : obj.getAsJsonArray("active")) {
									ChallengeCompletionEvent event = new ChallengeCompletionEvent(
											Bukkit.getPlayer(UUID
													.fromString(o.toString().substring(1, o.toString().length() - 1))),
											plugin);
	...
	public static <T extends JavaPlugin> void deleteLink(final long id, T plugin) {
